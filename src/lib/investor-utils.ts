...
export const initialInvestors: Investor[] = [
  ...
  { id: 12, name: "Aisha Okonkwo", email: "aisha@example.com", phone: "+1 555-1200", invested: 550000, investmentDate: "2025-04-22", status: "approved", shares: 55, bloodGroup: "O-", nidNumber: "2233445566", jerseySize: "M", nominee: { name: "Chidi Okonkwo", relationship: "Brother", phone: "+1 555-1222", nidNumber: "6655443322" }, history: [{ id: 13, date: "2025-04-22", amount: 550000, type: "deposit", status: "approved" }] },
  {
    ...
    shares: 35,
    bloodGroup: "A+",
    nidNumber: "3344556677",
    jerseySize: "L",
    nominee: { name: "Emma Bennett", relationship: "Wife", phone: "+1 555-1311", nidNumber: "7766554433" },
    history: [
      { id: 14, date: "2026-01-05", amount: 200000, type: "deposit", status: "approved" },
      { id: 15, date: "2026-03-12", amount: 150000, type: "deposit", status: "approved" },
      { id: 16, date: "2026-05-20", amount: 80000, type: "withdrawal", status: "approved" },
      { id: 17, date: "2026-08-01", amount: 100000, type: "deposit", status: "approved" },
      { id: 18, date: "2026-10-15", amount: 20000, type: "withdrawal", status: "approved" },
    ],
  },
];
