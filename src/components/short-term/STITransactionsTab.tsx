...
import { Search, CheckCircle, XCircle, Clock, CalendarIcon, FilterX, FileText } from "lucide-react";
...
export function STITransactionsTab({ project }: Props) {
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-muted/50">
              ...
              <th className="text-center px-3 py-2 font-medium text-muted-foreground">Invoice</th>
            </tr>
          </thead>
          <tbody>
                ...
                return (
                  <tr key={t.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-3 py-2">
                      <p className="font-medium text-foreground">{t.investorName}</p>
                    ...
                    <td className="px-3 py-2 text-center">
                      <Button size="sm" variant="ghost" className="h-7 px-2 text-xs gap-1" onClick={() => handleGenerateInvoice(t)}>
